...
import MaitriBookingBusCard from '../../../components/cards/MaitriBookingBusCard';
import MaitriBookingSingle from './maitriBookingSingle/MaitriBookingSingle';
...
const MaitriBookingIndex = () => {
    ...
    if (!showSingle) {
            ...
            <main className='px-16 max-[800px]:px-10 max-sm:px-8 my-14'>
                ...
                <div className='flex justify-between items-stretch gap-3 max-[1371px]:flex-col max-[1371px]:shadow-[0px_0px_10px_2px_rgba(0,0,0,0.1)] max-[1371px]:p-3 max-[1371px]:rounded-[10px]'>
                    <div className=' flex-2 flex gap-3 rounded-l-[10px] max-[1371px]:gap-10 max-[480px]:flex-col max-[480px]:gap-2'>
                        ...
                        <div className=' bg-[#53515120] max-[1371px]:bg-white max-[1371px]:border-b-[1px] max-[1371px]:border-b-black/20 items-center flex w-1/2 cursor-pointer max-[480px]:w-full relative'>
                            <div className='flex gap-3 items-center p-4 w-full h-full'
                                onClick={() => setShowDropOff(!showDropOff)}
                            >
                                <Location className='w-[20px] h-[20px] max-sm:w-[18px] max-sm:h-[18px] fill-black/50' />
                                <div>
                        ...
                        <div className='flex flex-col gap-8'>
                            {
                                [...Array(8)].map((_, index) => {
                                    ...
                                    return (
                                        <MaitriBookingBusCard key={index} setShowSingle={setShowSingle} 
        ...
        return (
            <MaitriBookingSingle setShowSingle={setShowSingle} />
        )
    }
}
